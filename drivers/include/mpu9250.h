...
/**
 * @defgroup    drivers_mpu9250 MPU-9250
...
#define MPU9250_WHOAMI_ANSWER  (0x71)
 ...
 * @{
 */
#define MPU9250_COMP_POWER_DOWN_MODE            (0x00)
#define MPU9250_COMP_SINGLE_MEASURE_MODE        (0x01)
#define MPU9250_COMP_CONTINUOUS_MEASURE_1_MODE  (0x02)
#define MPU9250_COMP_CONTINUOUS_MEASURE_2_MODE  (0x06)
#define MPU9250_COMP_SELF_TEST_MODE             (0x08)
#define MPU9250_COMP_FUSE_ROM_MODE              (0x0F)
...
typedef enum {
	 MPU9250_ACCEL_LPF_1130	=	0x08,                    // 1130Hz, 0.75mS delay
	 MPU9250_ACCEL_LPF_460	=	0x00,                    // 460Hz, 1.94mS delay
	 MPU9250_ACCEL_LPF_184	=	0x01,                    // 184Hz, 5.80mS delay
	 MPU9250_ACCEL_LPF_92	=	0x02,                    // 92Hz, 7.80mS delay
	 MPU9250_ACCEL_LPF_41	=	0x03,                    // 41Hz, 11.80mS delay
	 MPU9250_ACCEL_LPF_20	=	0x04,                    // 20Hz, 19.80mS delay
	 MPU9250_ACCEL_LPF_10	=	0x05,                    // 10Hz, 35.70mS delay
	 MPU9250_ACCEL_LPF_5	=	0x06,                    // 5Hz, 66.96mS delay
} mpu9250_accel_lpf_t;
...
typedef enum {
	MPU9250_GYRO_LPF_8800	=	0x11,                    // 8800Hz, 0.64mS delay
	MPU9250_GYRO_LPF_3600	=	0x10,                    // 3600Hz, 0.11mS delay
	MPU9250_GYRO_LPF_250	=	0x00,                    // 250Hz, 0.97mS delay
	MPU9250_GYRO_LPF_184	=	0x01,                    // 184Hz, 2.9mS delay
	MPU9250_GYRO_LPF_92	=	0x02,                    // 92Hz, 3.9mS delay
	MPU9250_GYRO_LPF_41	=	0x03,                    // 41Hz, 5.9mS delay
	MPU9250_GYRO_LPF_20	=	0x04,                    // 20Hz, 9.9mS delay
	MPU9250_GYRO_LPF_10	=	0x05,                    // 10Hz, 17.85mS delay
	MPU9250_GYRO_LPF_5	=	0x06,                    // 5Hz, 33.48mS delay
} mpu9250_gyro_lpf_t;
...
typedef struct {
    ...
    mpu9250_gyro_lpf_t gyro_lpf;   	/**< Gyro LPF freq */
    mpu9250_accel_lpf_t accel_lpf;   	/**< Accel LPF freq */
...
typedef struct {
    ...
    uint8_t hw_addr;            /**< Hardware address of the MPU-9250 */
